...
#ifndef _CANNABISDARKCOINRPC_H_
#define _CANNABISDARKCOINRPC_H_ 1
...
// CannabisDarkcoin RPC error codes
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // CannabisDarkcoin is not connected
...
/**
 * CannabisDarkcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
