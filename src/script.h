...
#ifndef H_CANNABISDARKCOIN_SCRIPT
#define H_CANNABISDARKCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CCannabisDarkcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, CannabisDarkcoin always counted CHECKMULTISIGs
